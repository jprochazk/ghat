...
const EDIT_DISCLAIMER: &str = "Do not edit: this file is generated by `ghat generate`.";
...
pub fn generate_action_dts(action_name: &str, manifest: &ActionManifest) -> String {
    ...
    writeln!(&mut out, "// {EDIT_DISCLAIMER}").ok();
...
pub fn generate_mappings_js(lockfile: &Lockfile, cache: &ManifestCache) -> String {
    let mut out = format!("// {EDIT_DISCLAIMER}\n");

    out.push_str("globalThis.__GHAT_ACTION_MAPPINGS = {\n");
